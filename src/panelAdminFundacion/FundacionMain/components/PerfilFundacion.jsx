    ...
    <>
      <div className="col-12 grid-margin mt-5">
        <div className="profile-header">
          <div className="cover">
            <figure>
              <Image src={fotoF} alt="profile cover" />
            </figure>
            <div className="cover-body d-flex justify-content-between align-items-center">
              <div className="d-flex align-items-center">
                <Image className="profile-pic" src={fotoP} alt="profile" />
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body className="mb-0">
          ...
          <p className="fw-light text-center">
            Esta acción es irreversible y una vez eliminada tu cuenta, no podrás
            recuperar la misma.
          </p>
        </Modal.Body>
        <Modal.Footer className="d-flex justify-content-center">
          <Button
            variant="danger"
            className="w-25"
            onClick={() => eliminarFundacion(idUsuarioAEliminar)}
          >
            Eliminar
          </Button>
